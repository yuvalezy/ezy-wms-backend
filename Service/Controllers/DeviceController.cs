...
namespace Service.Controllers
{
    ...
    public class DeviceController : ControllerBase
    {
        ...
        public async Task<ActionResult<DeviceResponse>> RegisterDevice([FromBody] RegisterDeviceRequest request)
        {
            ...
            {
                _logger.LogError(ex, "Error registering device {DeviceUuid}", request.DeviceUuid);
        ...
        public async Task<ActionResult<DeviceResponse>> GetDevice(string deviceUuid)
        {
            ...
            {
                _logger.LogError(ex, "Error getting device {DeviceUuid}", deviceUuid);
            ...
            string deviceUuid, [FromBody] UpdateDeviceStatusRequest request)
        {
            ...
            {
                _logger.LogError(ex, "Error updating device status for {DeviceUuid}", deviceUuid);
            ...
            string deviceUuid, [FromBody] UpdateDeviceNameRequest request)
        {
            ...
            {
                var sessionInfo = HttpContext.GetSession();
                var device = await _deviceService.UpdateDeviceNameAsync(
            ...
            {
                _logger.LogError(ex, "Error updating device name for {DeviceUuid}", deviceUuid);
        ...
        public async Task<ActionResult<List<DeviceAuditResponse>>> GetDeviceAuditHistory(string deviceUuid)
        {
            ...
            {
                _logger.LogError(ex, "Error getting audit history for device {DeviceUuid}", deviceUuid);
