...
group by T4."CardName", T3."CardName", T2."CardName", T4."CardCode", T3."CardCode", T2."CardCode", T4."DocNum", T3."DocNum", T2."DocNum", T0."OrderEntry", T0."BaseObject", T4."DocDate", T3."DocDate", T2."DocDate"