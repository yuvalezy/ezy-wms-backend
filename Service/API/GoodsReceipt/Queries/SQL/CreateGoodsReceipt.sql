...
insert into [@LW_YUVAL08_GRPO]("Name", "U_Date", "U_empID", "U_StatusDate", "U_StatusEmpID", "U_CardCode", "U_WhsCode")
OUTPUT inserted."Code" INTO @InsertedRows
values(@Name, getdate(), @EmpID, getdate(), @EmpID, @CardCode, @WhsCode)
