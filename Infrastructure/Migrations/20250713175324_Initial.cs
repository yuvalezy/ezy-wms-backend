    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CloudSyncQueues", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DeviceUuid = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataHash = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    CreatedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LicenseCaches", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LicenseCaches_Users_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LicenseCaches_Users_UpdatedByUserId",
                        column: x => x.UpdatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeviceAudits_Devices_DeviceId",
                        column: x => x.DeviceId,
                        principalTable: "Devices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeviceAudits_Users_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DeviceAudits_Users_UpdatedByUserId",
                        column: x => x.UpdatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountStatusAudits_CreatedByUserId",
                table: "AccountStatusAudits",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CloudSyncQueues_DeviceUuid",
                table: "CloudSyncQueues",
                column: "DeviceUuid");

            migrationBuilder.CreateIndex(
                name: "IX_CloudSyncQueues_EventType",
                table: "CloudSyncQueues",
                column: "EventType");

            migrationBuilder.CreateIndex(
                name: "IX_CloudSyncQueues_Status_NextRetryAt",
                table: "CloudSyncQueues",
                columns: new[] { "Status", "NextRetryAt" });

            migrationBuilder.CreateIndex(
                name: "IX_DeviceAudits_CreatedByUserId",
                table: "DeviceAudits",
                column: "CreatedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceAudits_UpdatedByUserId",
                table: "DeviceAudits",
                column: "UpdatedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LicenseCaches_CacheTimestamp",
                table: "LicenseCaches",
                column: "CacheTimestamp");

            migrationBuilder.CreateIndex(
                name: "IX_LicenseCaches_CreatedByUserId",
                table: "LicenseCaches",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_LicenseCaches_ExpirationTimestamp",
                table: "LicenseCaches",
                column: "ExpirationTimestamp");

            migrationBuilder.CreateIndex(
                name: "IX_LicenseCaches_UpdatedByUserId",
                table: "LicenseCaches",
                column: "UpdatedByUserId");
