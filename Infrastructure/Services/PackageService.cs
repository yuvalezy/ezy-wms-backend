    ...
    IPackageLocationService locationService) : IPackageService
{
    ...
    public async Task<List<Guid>> ActivatePackagesBySourceAsync(ObjectType sourceOperationType, Guid sourceOperationId, SessionInfo sessionInfo)
    {
