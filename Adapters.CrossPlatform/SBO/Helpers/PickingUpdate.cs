...
public class PickingUpdate(
    ...
    public async Task Execute() {
        try {
            ...
            await UpdateSourceDocumentSerialNumbers();
    ...
    private async Task UpdateSourceDocumentSerialNumbers() =>
        await SourceDocumentSerialWriter.WriteAsync(sboCompany, logger, absEntry, data, pickListResponse.PickListsLines);
